...
/**
 * @property-read Collection<int, Ticket> $serviceDeskAssignedTickets
 * @property-read Collection<int, Department> $serviceDeskDepartments
 * @property-read Collection<int, TicketHistory> $serviceDeskHistory
 */
trait IsOperator
{
    use HasTickets;
