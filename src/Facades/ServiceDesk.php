...
/**
 * @method static \JeffersonGoncalves\ServiceDesk\Models\Ticket createTicket(array<string, mixed> $data, \Illuminate\Database\Eloquent\Model $user)
 * @method static \JeffersonGoncalves\ServiceDesk\Models\Ticket updateTicket(\JeffersonGoncalves\ServiceDesk\Models\Ticket $ticket, array<string, mixed> $data, ?\Illuminate\Database\Eloquent\Model $performer = null)
 ...
 * @method static \JeffersonGoncalves\ServiceDesk\Models\TicketComment addComment(\JeffersonGoncalves\ServiceDesk\Models\Ticket $ticket, \Illuminate\Database\Eloquent\Model $author, string $body, array<string, mixed> $options = [])
 * @method static \JeffersonGoncalves\ServiceDesk\Models\TicketComment addNote(\JeffersonGoncalves\ServiceDesk\Models\Ticket $ticket, \Illuminate\Database\Eloquent\Model $author, string $body, array<string, mixed> $options = [])
 * @method static \JeffersonGoncalves\ServiceDesk\Models\Department createDepartment(array<string, mixed> $data)
