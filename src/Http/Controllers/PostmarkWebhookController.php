...
class PostmarkWebhookController extends Controller
{
    public function __construct(
        ...
        protected PostmarkDriver $driver,
    ) {}
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        try {
            ...
            if (isset($payload['StrippedTextReply']) && $payload['StrippedTextReply'] !== '') {
                $parsed['text_body'] = $payload['StrippedTextReply'];
            }
            ...
            if (! $channel) {
                Log::warning('Postmark webhook: no matching email channel found', [
                    'recipient' => $recipient,
                ]);
