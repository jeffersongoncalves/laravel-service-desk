...
use JeffersonGoncalves\ServiceDesk\Notifications\SlaBreachedNotification;
...
it('sends via the configured notification channels', function () {
    ...
    $notification = new SlaBreachedNotification($this->ticket, 'first_response');
...
it('builds an array payload with the breach type', function () {
    $notification = new SlaBreachedNotification($this->ticket, 'first_response');
